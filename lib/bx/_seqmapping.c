 ...
 */
  ...
  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":171
 *         a = self.table[x]
 *         # Symbols that map to -1 should not be touched
 *         if a < 0: return self             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":173
 *         if a < 0: return self
 *         # Count how many other input symbols map to a
 *         count = 0             # <<<<<<<<<<<<<<
 *         for i from 0 <= i < self.in_size:
 ...
 */
  ...
  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":174
 *         # Count how many other input symbols map to a
 *         count = 0
 *         for i from 0 <= i < self.in_size:             # <<<<<<<<<<<<<<
 *             if self.table[i] == a: count = count + 1
 ...
 */
  ...
  for (__pyx_v_i = 0; __pyx_v_i < __pyx_2; __pyx_v_i++) {
    ...
    /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":175
 *         count = 0
 *         for i from 0 <= i < self.in_size:
 *             if self.table[i] == a: count = count + 1             # <<<<<<<<<<<<<<
 *         # Already a singleton
 ...
 */
  ...
  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":177
 *             if self.table[i] == a: count = count + 1
 *         # Already a singleton
 *         if count < 2: return self             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":179
 *         if count < 2: return self
 *         # Otherwise, make a copy with the separated symbol
 *         copy = IntToIntMapping( self.in_size )             # <<<<<<<<<<<<<<
 *         copy.out_size = self.out_size + 1
 *         for i from 0 <= i < self.in_size:
 */
  __pyx_3 = PyInt_FromLong(((struct __pyx_obj_2bx_11_seqmapping_IntToIntMapping *)__pyx_v_self)->in_size); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 179; __pyx_clineno = __LINE__; goto __pyx_L1;}
  __pyx_4 = PyTuple_New(1); if (unlikely(!__pyx_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 179; __pyx_clineno = __LINE__; goto __pyx_L1;}
  PyTuple_SET_ITEM(__pyx_4, 0, __pyx_3);
  __pyx_3 = 0;
  __pyx_3 = PyObject_Call(((PyObject*)__pyx_ptype_2bx_11_seqmapping_IntToIntMapping), ((PyObject *)__pyx_4), NULL); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 179; __pyx_clineno = __LINE__; goto __pyx_L1;}
  Py_DECREF(((PyObject *)__pyx_4)); __pyx_4 = 0;
  if (!(__Pyx_TypeTest(__pyx_3, __pyx_ptype_2bx_11_seqmapping_IntToIntMapping))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 179; __pyx_clineno = __LINE__; goto __pyx_L1;}
  Py_DECREF(((PyObject *)__pyx_v_copy));
  __pyx_v_copy = ((struct __pyx_obj_2bx_11_seqmapping_IntToIntMapping *)__pyx_3);
  __pyx_3 = 0;

  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":180
 *         # Otherwise, make a copy with the separated symbol
 *         copy = IntToIntMapping( self.in_size )
 *         copy.out_size = self.out_size + 1             # <<<<<<<<<<<<<<
 *         for i from 0 <= i < self.in_size:
 ...
 */
  ...
  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":181
 *         copy = IntToIntMapping( self.in_size )
 *         copy.out_size = self.out_size + 1
 *         for i from 0 <= i < self.in_size:             # <<<<<<<<<<<<<<
 *             copy.table[i] = self.table[i]
 ...
 */
  ...
  for (__pyx_v_i = 0; __pyx_v_i < __pyx_2; __pyx_v_i++) {
    ...
    /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":182
 *         copy.out_size = self.out_size + 1
 *         for i from 0 <= i < self.in_size:
 *             copy.table[i] = self.table[i]             # <<<<<<<<<<<<<<
 *         copy.table[x] = self.out_size
 ...
 */
  ...
  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":183
 *         for i from 0 <= i < self.in_size:
 *             copy.table[i] = self.table[i]
 *         copy.table[x] = self.out_size             # <<<<<<<<<<<<<<
 *         return copy
 ...
 */
  ...
  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":184
 *             copy.table[i] = self.table[i]
 *         copy.table[x] = self.out_size
 *         return copy             # <<<<<<<<<<<<<<
 * 
...
/* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":186
 *         return copy
 * 
 *     def expand_out( self, int a ):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pf_2bx_11_seqmapping_15IntToIntMapping_expand_out(PyObject *__pyx_v_self, PyObject *__pyx_arg_a) {
  ...
  PyObject *__pyx_5 = 0;
  assert(__pyx_arg_a); {
    __pyx_v_a = __pyx_PyInt_int(__pyx_arg_a); if (unlikely((__pyx_v_a == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 186; __pyx_clineno = __LINE__; goto __pyx_L2;}
  }
  goto __pyx_L3;
  __pyx_L2:;
  ...
  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":190
 *         cdef int i, count, to_split, b
 *         cdef IntToIntMapping copy
 *         count = 0             # <<<<<<<<<<<<<<
 *         for i from 0 <= i < self.in_size:
 ...
 */
  ...
  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":191
 *         cdef IntToIntMapping copy
 *         count = 0
 *         for i from 0 <= i < self.in_size:             # <<<<<<<<<<<<<<
 *             if self.table[i] == a: count = count + 1
 ...
 */
  ...
  for (__pyx_v_i = 0; __pyx_v_i < __pyx_1; __pyx_v_i++) {
    ...
    /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":192
 *         count = 0
 *         for i from 0 <= i < self.in_size:
 *             if self.table[i] == a: count = count + 1             # <<<<<<<<<<<<<<
 *         if count < 2: return self
 ...
 */
  ...
  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":193
 *         for i from 0 <= i < self.in_size:
 *             if self.table[i] == a: count = count + 1
 *         if count < 2: return self             # <<<<<<<<<<<<<<
 *         copy = IntToIntMapping( self.in_size )
 ...
 */
  ...
  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":194
 *             if self.table[i] == a: count = count + 1
 *         if count < 2: return self
 *         copy = IntToIntMapping( self.in_size )             # <<<<<<<<<<<<<<
 *         copy.out_size = self.out_size + 1
 *         b = self.out_size
 */
  __pyx_3 = PyInt_FromLong(((struct __pyx_obj_2bx_11_seqmapping_IntToIntMapping *)__pyx_v_self)->in_size); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 194; __pyx_clineno = __LINE__; goto __pyx_L1;}
  __pyx_4 = PyTuple_New(1); if (unlikely(!__pyx_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 194; __pyx_clineno = __LINE__; goto __pyx_L1;}
  PyTuple_SET_ITEM(__pyx_4, 0, __pyx_3);
  __pyx_3 = 0;
  __pyx_3 = PyObject_Call(((PyObject*)__pyx_ptype_2bx_11_seqmapping_IntToIntMapping), ((PyObject *)__pyx_4), NULL); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 194; __pyx_clineno = __LINE__; goto __pyx_L1;}
  Py_DECREF(((PyObject *)__pyx_4)); __pyx_4 = 0;
  if (!(__Pyx_TypeTest(__pyx_3, __pyx_ptype_2bx_11_seqmapping_IntToIntMapping))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 194; __pyx_clineno = __LINE__; goto __pyx_L1;}
  Py_DECREF(((PyObject *)__pyx_v_copy));
  __pyx_v_copy = ((struct __pyx_obj_2bx_11_seqmapping_IntToIntMapping *)__pyx_3);
  __pyx_3 = 0;

  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":195
 *         if count < 2: return self
 *         copy = IntToIntMapping( self.in_size )
 *         copy.out_size = self.out_size + 1             # <<<<<<<<<<<<<<
 *         b = self.out_size
 ...
 */
  ...
  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":196
 *         copy = IntToIntMapping( self.in_size )
 *         copy.out_size = self.out_size + 1
 *         b = self.out_size             # <<<<<<<<<<<<<<
 *         to_split = random.randrange( count )
 ...
 */
  ...
  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":197
 *         copy.out_size = self.out_size + 1
 *         b = self.out_size
 *         to_split = random.randrange( count )             # <<<<<<<<<<<<<<
 *         count = 0
 *         for i from 0 <= i < self.in_size:
 */
  __pyx_4 = __Pyx_GetName(__pyx_m, __pyx_kp_random); if (unlikely(!__pyx_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 197; __pyx_clineno = __LINE__; goto __pyx_L1;}
  __pyx_3 = PyObject_GetAttr(__pyx_4, __pyx_kp_randrange); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 197; __pyx_clineno = __LINE__; goto __pyx_L1;}
  Py_DECREF(__pyx_4); __pyx_4 = 0;
  __pyx_4 = PyInt_FromLong(__pyx_v_count); if (unlikely(!__pyx_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 197; __pyx_clineno = __LINE__; goto __pyx_L1;}
  __pyx_5 = PyTuple_New(1); if (unlikely(!__pyx_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 197; __pyx_clineno = __LINE__; goto __pyx_L1;}
  PyTuple_SET_ITEM(__pyx_5, 0, __pyx_4);
  __pyx_4 = 0;
  __pyx_4 = PyObject_Call(__pyx_3, ((PyObject *)__pyx_5), NULL); if (unlikely(!__pyx_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 197; __pyx_clineno = __LINE__; goto __pyx_L1;}
  Py_DECREF(__pyx_3); __pyx_3 = 0;
  Py_DECREF(((PyObject *)__pyx_5)); __pyx_5 = 0;
  __pyx_1 = __pyx_PyInt_int(__pyx_4); if (unlikely((__pyx_1 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 197; __pyx_clineno = __LINE__; goto __pyx_L1;}
  Py_DECREF(__pyx_4); __pyx_4 = 0;
  __pyx_v_to_split = __pyx_1;

  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":198
 *         b = self.out_size
 *         to_split = random.randrange( count )
 *         count = 0             # <<<<<<<<<<<<<<
 *         for i from 0 <= i < self.in_size:
 ...
 */
  ...
  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":199
 *         to_split = random.randrange( count )
 *         count = 0
 *         for i from 0 <= i < self.in_size:             # <<<<<<<<<<<<<<
 *             if self.table[i] == a:
 ...
 */
  ...
  for (__pyx_v_i = 0; __pyx_v_i < __pyx_1; __pyx_v_i++) {
    ...
    /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":200
 *         count = 0
 *         for i from 0 <= i < self.in_size:
 *             if self.table[i] == a:             # <<<<<<<<<<<<<<
 *                 if count == to_split: copy.table[i] = b
 ...
 */
    ...
    if (__pyx_2) {
      ...
      /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":201
 *         for i from 0 <= i < self.in_size:
 *             if self.table[i] == a:
 *                 if count == to_split: copy.table[i] = b             # <<<<<<<<<<<<<<
 *                 else: copy.table[i] = a
 ...
 */
      ...
      /*else*/ {
        ...
        /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":202
 *             if self.table[i] == a:
 *                 if count == to_split: copy.table[i] = b
 *                 else: copy.table[i] = a             # <<<<<<<<<<<<<<
 *                 count = count + 1
 ...
 */
      ...
      /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":203
 *                 if count == to_split: copy.table[i] = b
 *                 else: copy.table[i] = a
 *                 count = count + 1             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
    ...
    /*else*/ {
      ...
      /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":205
 *                 count = count + 1
 *             else:
 *                 copy.table[i] = self.table[i]             # <<<<<<<<<<<<<<
 *         return copy
 ...
 */
  ...
  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":206
 *             else:
 *                 copy.table[i] = self.table[i]
 *         return copy             # <<<<<<<<<<<<<<
 * 
...
/* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":208
 *         return copy
 * 
 *     def expand_random_split( self, int a ):             # <<<<<<<<<<<<<<
 *         """Grow the alphabet breaking 'a' into two symbols randomly"""
...
static PyObject *__pyx_pf_2bx_11_seqmapping_15IntToIntMapping_expand_random_split(PyObject *__pyx_v_self, PyObject *__pyx_arg_a) {
  ...
  PyObject *__pyx_6 = 0;
  assert(__pyx_arg_a); {
    __pyx_v_a = __pyx_PyInt_int(__pyx_arg_a); if (unlikely((__pyx_v_a == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 208; __pyx_clineno = __LINE__; goto __pyx_L2;}
  }
  goto __pyx_L3;
  __pyx_L2:;
  ...
  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":212
 *         cdef int i, count, b
 *         cdef IntToIntMapping copy
 *         count = 0             # <<<<<<<<<<<<<<
 *         for i from 0 <= i < self.in_size:
 ...
 */
  ...
  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":213
 *         cdef IntToIntMapping copy
 *         count = 0
 *         for i from 0 <= i < self.in_size:             # <<<<<<<<<<<<<<
 *             if self.table[i] == a: count = count + 1
 ...
 */
  ...
  for (__pyx_v_i = 0; __pyx_v_i < __pyx_1; __pyx_v_i++) {
    ...
    /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":214
 *         count = 0
 *         for i from 0 <= i < self.in_size:
 *             if self.table[i] == a: count = count + 1             # <<<<<<<<<<<<<<
 *         if count < 2: return self
 ...
 */
  ...
  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":215
 *         for i from 0 <= i < self.in_size:
 *             if self.table[i] == a: count = count + 1
 *         if count < 2: return self             # <<<<<<<<<<<<<<
 *         copy = IntToIntMapping( self.in_size )
 ...
 */
  ...
  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":216
 *             if self.table[i] == a: count = count + 1
 *         if count < 2: return self
 *         copy = IntToIntMapping( self.in_size )             # <<<<<<<<<<<<<<
 *         copy.out_size = self.out_size + 1
 *         b = self.out_size
 */
  __pyx_3 = PyInt_FromLong(((struct __pyx_obj_2bx_11_seqmapping_IntToIntMapping *)__pyx_v_self)->in_size); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 216; __pyx_clineno = __LINE__; goto __pyx_L1;}
  __pyx_4 = PyTuple_New(1); if (unlikely(!__pyx_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 216; __pyx_clineno = __LINE__; goto __pyx_L1;}
  PyTuple_SET_ITEM(__pyx_4, 0, __pyx_3);
  __pyx_3 = 0;
  __pyx_3 = PyObject_Call(((PyObject*)__pyx_ptype_2bx_11_seqmapping_IntToIntMapping), ((PyObject *)__pyx_4), NULL); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 216; __pyx_clineno = __LINE__; goto __pyx_L1;}
  Py_DECREF(((PyObject *)__pyx_4)); __pyx_4 = 0;
  if (!(__Pyx_TypeTest(__pyx_3, __pyx_ptype_2bx_11_seqmapping_IntToIntMapping))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 216; __pyx_clineno = __LINE__; goto __pyx_L1;}
  Py_DECREF(((PyObject *)__pyx_v_copy));
  __pyx_v_copy = ((struct __pyx_obj_2bx_11_seqmapping_IntToIntMapping *)__pyx_3);
  __pyx_3 = 0;

  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":217
 *         if count < 2: return self
 *         copy = IntToIntMapping( self.in_size )
 *         copy.out_size = self.out_size + 1             # <<<<<<<<<<<<<<
 *         b = self.out_size
 ...
 */
  ...
  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":218
 *         copy = IntToIntMapping( self.in_size )
 *         copy.out_size = self.out_size + 1
 *         b = self.out_size             # <<<<<<<<<<<<<<
 *         to_split = random.sample( range( count ), count/2 )
 ...
 */
  ...
  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":219
 *         copy.out_size = self.out_size + 1
 *         b = self.out_size
 *         to_split = random.sample( range( count ), count/2 )             # <<<<<<<<<<<<<<
 *         count = 0
 *         for i from 0 <= i < self.in_size:
 */
  __pyx_4 = __Pyx_GetName(__pyx_m, __pyx_kp_random); if (unlikely(!__pyx_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 219; __pyx_clineno = __LINE__; goto __pyx_L1;}
  __pyx_3 = PyObject_GetAttr(__pyx_4, __pyx_kp_sample); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 219; __pyx_clineno = __LINE__; goto __pyx_L1;}
  Py_DECREF(__pyx_4); __pyx_4 = 0;
  __pyx_4 = PyInt_FromLong(__pyx_v_count); if (unlikely(!__pyx_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 219; __pyx_clineno = __LINE__; goto __pyx_L1;}
  __pyx_5 = PyTuple_New(1); if (unlikely(!__pyx_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 219; __pyx_clineno = __LINE__; goto __pyx_L1;}
  PyTuple_SET_ITEM(__pyx_5, 0, __pyx_4);
  __pyx_4 = 0;
  __pyx_4 = PyObject_Call(__pyx_builtin_range, ((PyObject *)__pyx_5), NULL); if (unlikely(!__pyx_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 219; __pyx_clineno = __LINE__; goto __pyx_L1;}
  Py_DECREF(((PyObject *)__pyx_5)); __pyx_5 = 0;
  __pyx_5 = PyInt_FromLong((__pyx_v_count / 2)); if (unlikely(!__pyx_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 219; __pyx_clineno = __LINE__; goto __pyx_L1;}
  __pyx_6 = PyTuple_New(2); if (unlikely(!__pyx_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 219; __pyx_clineno = __LINE__; goto __pyx_L1;}
  PyTuple_SET_ITEM(__pyx_6, 0, __pyx_4);
  PyTuple_SET_ITEM(__pyx_6, 1, __pyx_5);
  __pyx_4 = 0;
  __pyx_5 = 0;
  __pyx_4 = PyObject_Call(__pyx_3, ((PyObject *)__pyx_6), NULL); if (unlikely(!__pyx_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 219; __pyx_clineno = __LINE__; goto __pyx_L1;}
  Py_DECREF(__pyx_3); __pyx_3 = 0;
  ...
  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":220
 *         b = self.out_size
 *         to_split = random.sample( range( count ), count/2 )
 *         count = 0             # <<<<<<<<<<<<<<
 *         for i from 0 <= i < self.in_size:
 ...
 */
  ...
  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":221
 *         to_split = random.sample( range( count ), count/2 )
 *         count = 0
 *         for i from 0 <= i < self.in_size:             # <<<<<<<<<<<<<<
 *             if self.table[i] == a:
 ...
 */
  ...
  for (__pyx_v_i = 0; __pyx_v_i < __pyx_1; __pyx_v_i++) {
    ...
    /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":222
 *         count = 0
 *         for i from 0 <= i < self.in_size:
 *             if self.table[i] == a:             # <<<<<<<<<<<<<<
 *                 if count in to_split: copy.table[i] = b
 ...
 */
    ...
    if (__pyx_2) {
      ...
      /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":223
 *         for i from 0 <= i < self.in_size:
 *             if self.table[i] == a:
 *                 if count in to_split: copy.table[i] = b             # <<<<<<<<<<<<<<
 *                 else: copy.table[i] = a
 *                 count = count + 1
 */
      __pyx_5 = PyInt_FromLong(__pyx_v_count); if (unlikely(!__pyx_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 223; __pyx_clineno = __LINE__; goto __pyx_L1;}
      __pyx_2 = (PySequence_Contains(__pyx_v_to_split, __pyx_5)); if (unlikely(__pyx_2 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 223; __pyx_clineno = __LINE__; goto __pyx_L1;}
      ...
      /*else*/ {
        ...
        /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":224
 *             if self.table[i] == a:
 *                 if count in to_split: copy.table[i] = b
 *                 else: copy.table[i] = a             # <<<<<<<<<<<<<<
 *                 count = count + 1
 ...
 */
      ...
      /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":225
 *                 if count in to_split: copy.table[i] = b
 *                 else: copy.table[i] = a
 *                 count = count + 1             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
    ...
    /*else*/ {
      ...
      /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":227
 *                 count = count + 1
 *             else:
 *                 copy.table[i] = self.table[i]             # <<<<<<<<<<<<<<
 *         return copy
 ...
 */
  ...
  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":228
 *             else:
 *                 copy.table[i] = self.table[i]
 *         return copy             # <<<<<<<<<<<<<<
 * 
...
/* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":230
 *         return copy
 * 
 *     def get_in_size( self ):             # <<<<<<<<<<<<<<
 *         return self.in_size
...
static PyObject *__pyx_pf_2bx_11_seqmapping_15IntToIntMapping_get_in_size(PyObject *__pyx_v_self, PyObject *unused) {
  ...
  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":231
 * 
 *     def get_in_size( self ):
 *         return self.in_size             # <<<<<<<<<<<<<<
 * 
 *     def get_out_size( self ):
 */
  __pyx_1 = PyInt_FromLong(((struct __pyx_obj_2bx_11_seqmapping_IntToIntMapping *)__pyx_v_self)->in_size); if (unlikely(!__pyx_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 231; __pyx_clineno = __LINE__; goto __pyx_L1;}
  __pyx_r = __pyx_1;
  __pyx_1 = 0;
  goto __pyx_L0;
...
/* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":233
 *         return self.in_size
 * 
 *     def get_out_size( self ):             # <<<<<<<<<<<<<<
 *         return self.out_size
...
static PyObject *__pyx_pf_2bx_11_seqmapping_15IntToIntMapping_get_out_size(PyObject *__pyx_v_self, PyObject *unused) {
  ...
  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":234
 * 
 *     def get_out_size( self ):
 *         return self.out_size             # <<<<<<<<<<<<<<
 * 
 *     def get_table( self ):
 */
  __pyx_1 = PyInt_FromLong(((struct __pyx_obj_2bx_11_seqmapping_IntToIntMapping *)__pyx_v_self)->out_size); if (unlikely(!__pyx_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 234; __pyx_clineno = __LINE__; goto __pyx_L1;}
  __pyx_r = __pyx_1;
  __pyx_1 = 0;
  goto __pyx_L0;
...
/* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":236
 *         return self.out_size
 * 
 *     def get_table( self ):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pf_2bx_11_seqmapping_15IntToIntMapping_get_table(PyObject *__pyx_v_self, PyObject *unused) {
  ...
  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":237
 * 
 *     def get_table( self ):
 *         rval = zeros( self.in_size, 'i' )             # <<<<<<<<<<<<<<
 *         for i in range( self.in_size ):
 *             rval[i] = self.table[i]
 */
  __pyx_1 = __Pyx_GetName(__pyx_m, __pyx_kp_zeros); if (unlikely(!__pyx_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 237; __pyx_clineno = __LINE__; goto __pyx_L1;}
  __pyx_2 = PyInt_FromLong(((struct __pyx_obj_2bx_11_seqmapping_IntToIntMapping *)__pyx_v_self)->in_size); if (unlikely(!__pyx_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 237; __pyx_clineno = __LINE__; goto __pyx_L1;}
  __pyx_3 = PyTuple_New(2); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 237; __pyx_clineno = __LINE__; goto __pyx_L1;}
  PyTuple_SET_ITEM(__pyx_3, 0, __pyx_2);
  Py_INCREF(__pyx_kp_7);
  PyTuple_SET_ITEM(__pyx_3, 1, __pyx_kp_7);
  __pyx_2 = 0;
  __pyx_2 = PyObject_Call(__pyx_1, ((PyObject *)__pyx_3), NULL); if (unlikely(!__pyx_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 237; __pyx_clineno = __LINE__; goto __pyx_L1;}
  Py_DECREF(__pyx_1); __pyx_1 = 0;
  Py_DECREF(((PyObject *)__pyx_3)); __pyx_3 = 0;
  Py_DECREF(__pyx_v_rval);
  ...
  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":238
 *     def get_table( self ):
 *         rval = zeros( self.in_size, 'i' )
 *         for i in range( self.in_size ):             # <<<<<<<<<<<<<<
 *             rval[i] = self.table[i]
 *         return rval
 */
  __pyx_1 = PyInt_FromLong(((struct __pyx_obj_2bx_11_seqmapping_IntToIntMapping *)__pyx_v_self)->in_size); if (unlikely(!__pyx_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 238; __pyx_clineno = __LINE__; goto __pyx_L1;}
  __pyx_3 = PyTuple_New(1); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 238; __pyx_clineno = __LINE__; goto __pyx_L1;}
  PyTuple_SET_ITEM(__pyx_3, 0, __pyx_1);
  __pyx_1 = 0;
  __pyx_2 = PyObject_Call(__pyx_builtin_range, ((PyObject *)__pyx_3), NULL); if (unlikely(!__pyx_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 238; __pyx_clineno = __LINE__; goto __pyx_L1;}
  Py_DECREF(((PyObject *)__pyx_3)); __pyx_3 = 0;
  if (PyList_CheckExact(__pyx_2)) { __pyx_4 = 0; __pyx_1 = __pyx_2; Py_INCREF(__pyx_1); }
  else { __pyx_1 = PyObject_GetIter(__pyx_2); if (unlikely(!__pyx_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 238; __pyx_clineno = __LINE__; goto __pyx_L1;} }
  Py_DECREF(__pyx_2); __pyx_2 = 0;
  for (;;) {
    if (PyList_CheckExact(__pyx_1)) { if (__pyx_4 >= PyList_GET_SIZE(__pyx_1)) break; __pyx_3 = PyList_GET_ITEM(__pyx_1, __pyx_4++); Py_INCREF(__pyx_3); }
      ...
      if (!__pyx_3) {
        if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 238; __pyx_clineno = __LINE__; goto __pyx_L1;}
        break;
      }
    }
    Py_DECREF(__pyx_v_i);
    ...
    /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":239
 *         rval = zeros( self.in_size, 'i' )
 *         for i in range( self.in_size ):
 *             rval[i] = self.table[i]             # <<<<<<<<<<<<<<
 *         return rval
 * 
 */
    __pyx_5 = __pyx_PyIndex_AsSsize_t(__pyx_v_i); if (unlikely((__pyx_5 == (Py_ssize_t)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 239; __pyx_clineno = __LINE__; goto __pyx_L1;}
    __pyx_2 = PyInt_FromLong((((struct __pyx_obj_2bx_11_seqmapping_IntToIntMapping *)__pyx_v_self)->table[__pyx_5])); if (unlikely(!__pyx_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 239; __pyx_clineno = __LINE__; goto __pyx_L1;}
    if (PyObject_SetItem(__pyx_v_rval, __pyx_v_i, __pyx_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 239; __pyx_clineno = __LINE__; goto __pyx_L1;}
    Py_DECREF(__pyx_2); __pyx_2 = 0;
  }
  Py_DECREF(__pyx_1); __pyx_1 = 0;

  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":240
 *         for i in range( self.in_size ):
 *             rval[i] = self.table[i]
 *         return rval             # <<<<<<<<<<<<<<
 * 
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_set_mapping, __pyx_k_set_mapping, sizeof(__pyx_k_set_mapping), 0, 1, 1},
  {&__pyx_kp_translate, __pyx_k_translate, sizeof(__pyx_k_translate), 0, 1, 1},
  {&__pyx_kp_translate_list, __pyx_k_translate_list, sizeof(__pyx_k_translate_list), 0, 1, 1},
  {&__pyx_kp_reverse_map, __pyx_k_reverse_map, sizeof(__pyx_k_reverse_map), 0, 1, 1},
  {&__pyx_kp_get_out_size, __pyx_k_get_out_size, sizeof(__pyx_k_get_out_size), 0, 1, 1},
  ...
  {&__pyx_kp_collapse, __pyx_k_collapse, sizeof(__pyx_k_collapse), 0, 1, 1},
  {&__pyx_kp_expand, __pyx_k_expand, sizeof(__pyx_k_expand), 0, 1, 1},
  {&__pyx_kp_expand_out, __pyx_k_expand_out, sizeof(__pyx_k_expand_out), 0, 1, 1},
  {&__pyx_kp_expand_random_split, __pyx_k_expand_random_split, sizeof(__pyx_k_expand_random_split), 0, 1, 1},
  {&__pyx_kp_get_in_size, __pyx_k_get_in_size, sizeof(__pyx_k_get_in_size), 0, 1, 1},
  {&__pyx_kp_get_table, __pyx_k_get_table, sizeof(__pyx_k_get_table), 0, 1, 1},
...
PyMODINIT_FUNC init_seqmapping(void) {
  ...
  /*--- Builtin init code ---*/
  __pyx_builtin_ord = __Pyx_GetName(__pyx_b, __pyx_kp_ord); if (!__pyx_builtin_ord) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 37; __pyx_clineno = __LINE__; goto __pyx_L1;}
  __pyx_builtin_chr = __Pyx_GetName(__pyx_b, __pyx_kp_chr); if (!__pyx_builtin_chr) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L1;}
  __pyx_builtin_range = __Pyx_GetName(__pyx_b, __pyx_kp_range); if (!__pyx_builtin_range) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 219; __pyx_clineno = __LINE__; goto __pyx_L1;}
  __pyx_skip_dispatch = 0;
  /*--- Global init code ---*/
  /*--- Function export code ---*/
  /*--- Type init code ---*/
  if (PyType_Ready(&__pyx_type_2bx_11_seqmapping_CharToIntArrayMapping) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1;}
  if (PyObject_SetAttrString(__pyx_m, "CharToIntArrayMapping", (PyObject *)&__pyx_type_2bx_11_seqmapping_CharToIntArrayMapping) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1;}
  __pyx_ptype_2bx_11_seqmapping_CharToIntArrayMapping = &__pyx_type_2bx_11_seqmapping_CharToIntArrayMapping;
  if (PyType_Ready(&__pyx_type_2bx_11_seqmapping_IntToIntMapping) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L1;}
  if (PyObject_SetAttrString(__pyx_m, "IntToIntMapping", (PyObject *)&__pyx_type_2bx_11_seqmapping_IntToIntMapping) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L1;}
  __pyx_ptype_2bx_11_seqmapping_IntToIntMapping = &__pyx_type_2bx_11_seqmapping_IntToIntMapping;
  /*--- Type import code ---*/
  /*--- Function import code ---*/
  /*--- Execution code ---*/

  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":14
 ...
 */
  ...
  __pyx_2 = __Pyx_Import(__pyx_kp_numpy, ((PyObject *)__pyx_1)); if (unlikely(!__pyx_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1;}
  Py_DECREF(((PyObject *)__pyx_1)); __pyx_1 = 0;
  __pyx_1 = PyObject_GetAttr(__pyx_2, __pyx_kp_zeros); if (unlikely(!__pyx_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1;}
  if (PyObject_SetAttr(__pyx_m, __pyx_kp_zeros, __pyx_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1;}
  Py_DECREF(__pyx_1); __pyx_1 = 0;
  Py_DECREF(__pyx_2); __pyx_2 = 0;

  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":15
 * 
 * from numpy import zeros
 * from math import floor             # <<<<<<<<<<<<<<
 * import random
 * import sys
 */
  __pyx_2 = PyList_New(1); if (unlikely(!__pyx_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1;}
  Py_INCREF(__pyx_kp_floor);
  PyList_SET_ITEM(__pyx_2, 0, __pyx_kp_floor);
  __pyx_1 = __Pyx_Import(__pyx_kp_math, ((PyObject *)__pyx_2)); if (unlikely(!__pyx_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1;}
  Py_DECREF(((PyObject *)__pyx_2)); __pyx_2 = 0;
  __pyx_2 = PyObject_GetAttr(__pyx_1, __pyx_kp_floor); if (unlikely(!__pyx_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1;}
  if (PyObject_SetAttr(__pyx_m, __pyx_kp_floor, __pyx_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1;}
  Py_DECREF(__pyx_2); __pyx_2 = 0;
  Py_DECREF(__pyx_1); __pyx_1 = 0;

  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":16
 * from numpy import zeros
 * from math import floor
 * import random             # <<<<<<<<<<<<<<
 * import sys
 * 
 */
  __pyx_1 = __Pyx_Import(__pyx_kp_random, 0); if (unlikely(!__pyx_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1;}
  if (PyObject_SetAttr(__pyx_m, __pyx_kp_random, __pyx_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1;}
  Py_DECREF(__pyx_1); __pyx_1 = 0;

  /* "/home/james/src/bx-python-trunk/lib/bx/_seqmapping.pyx":17
 * from math import floor
 * import random
 * import sys             # <<<<<<<<<<<<<<
 * 
 * cdef class CharToIntArrayMapping:
 */
  __pyx_2 = __Pyx_Import(__pyx_kp_sys, 0); if (unlikely(!__pyx_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; __pyx_clineno = __LINE__; goto __pyx_L1;}
  if (PyObject_SetAttr(__pyx_m, __pyx_kp_sys, __pyx_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; __pyx_clineno = __LINE__; goto __pyx_L1;}
  Py_DECREF(__pyx_2); __pyx_2 = 0;
