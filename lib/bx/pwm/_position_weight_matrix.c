...
static char __pyx_k_1[] = "bx.pwm._position_weight_matrix";
...
static PyMethodDef __pyx_mdef_2bx_3pwm_23_position_weight_matrix_c_match_consensus = {__Pyx_NAMESTR("c_match_consensus"), (PyCFunction)__pyx_pf_2bx_3pwm_23_position_weight_matrix_c_match_consensus, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)};
static PyObject *__pyx_pf_2bx_3pwm_23_position_weight_matrix_c_match_consensus(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("c_match_consensus");
...
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit__position_weight_matrix(void)");
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("_position_weight_matrix"), __pyx_methods, 0, 0, PYTHON_API_VERSION);
  #else
 ...
 *     return pattern_match( sequence, pattern, size )
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_2bx_3pwm_23_position_weight_matrix_c_match_consensus, NULL, __pyx_n_s_1); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 4; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
