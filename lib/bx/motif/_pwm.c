...
static char __pyx_k_2[] = "bx.motif._pwm";
static char __pyx_k_3[] = "score_string_with_gaps";
...
static PyMethodDef __pyx_mdef_2bx_5motif_4_pwm_score_string = {__Pyx_NAMESTR("score_string"), (PyCFunction)__pyx_pf_2bx_5motif_4_pwm_score_string, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_2bx_5motif_4_pwm_score_string)};
static PyObject *__pyx_pf_2bx_5motif_4_pwm_score_string(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("score_string");
  __pyx_self = __pyx_self;
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (PyTuple_GET_SIZE(__pyx_args)) {
        ...
        case  1:
        values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__char_to_index);
        ...
        case  3:
        values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__rval);
...
static PyObject *__pyx_pf_2bx_5motif_4_pwm_1score_string_with_gaps(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_2bx_5motif_4_pwm_1score_string_with_gaps[] = "\n    Score each position in string `string` using the scoring matrix `matrix`.\n    Characters in the string are mapped to columns in the matrix by `char_to_index`\n    and the score for each position is stored in `rval`.\n\n    matrix *must* be a 2d array of type float32\n    char_to_index *must* be a 1d array of type int16\n    rval *must* be a 1d array of type float32 and the same length as string\n    ";
static PyMethodDef __pyx_mdef_2bx_5motif_4_pwm_1score_string_with_gaps = {__Pyx_NAMESTR("score_string_with_gaps"), (PyCFunction)__pyx_pf_2bx_5motif_4_pwm_1score_string_with_gaps, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_2bx_5motif_4_pwm_1score_string_with_gaps)};
static PyObject *__pyx_pf_2bx_5motif_4_pwm_1score_string_with_gaps(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_matrix = 0;
  PyArrayObject *__pyx_v_char_to_index = 0;
  PyObject *__pyx_v_string = 0;
  PyArrayObject *__pyx_v_rval = 0;
  ...
  int __pyx_clineno = 0;
  static PyObject **__pyx_pyargnames[] = {&__pyx_n_s__matrix,&__pyx_n_s__char_to_index,&__pyx_n_s__string,&__pyx_n_s__rval,0};
  __Pyx_RefNannySetupContext("score_string_with_gaps");
  __pyx_self = __pyx_self;
  {
    PyObject* values[4] = {0,0,0,0};
    if (unlikely(__pyx_kwds)) {
...
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit__pwm(void)");
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("_pwm"), __pyx_methods, __Pyx_DOCSTR(__pyx_k_1), 0, PYTHON_API_VERSION);
  #else
 ...
 *     Score each position in string `string` using the scoring matrix `matrix`.
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_2bx_5motif_4_pwm_score_string, NULL, __pyx_n_s_2); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     Score each position in string `string` using the scoring matrix `matrix`.
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_2bx_5motif_4_pwm_1score_string_with_gaps, NULL, __pyx_n_s_2); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 50; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s_3, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 50; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
