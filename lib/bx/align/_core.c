...
static char __pyx_k_2[] = "bx.align._core";
...
static PyMethodDef __pyx_mdef_2bx_5align_5_core_coord_to_col = {__Pyx_NAMESTR("coord_to_col"), (PyCFunction)__pyx_pf_2bx_5align_5_core_coord_to_col, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)};
static PyObject *__pyx_pf_2bx_5align_5_core_coord_to_col(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("coord_to_col");
...
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit__core(void)");
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("_core"), __pyx_methods, __Pyx_DOCSTR(__pyx_k_1), 0, PYTHON_API_VERSION);
  #else
 ...
 *     col = 0
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_2bx_5align_5_core_coord_to_col, NULL, __pyx_n_s_2); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 5; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
