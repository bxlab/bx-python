 ...
 */
  ...
  /* "/home/james/projects/bx-python/code/bx-python/lib/bx/bbi/cirtree_file.pyx":34
 *         self.file = file
 *         self.reader = reader = BinaryFileReader( file, cir_tree_sig )
 *         self.is_byteswapped = self.reader.byteswap_needed             # <<<<<<<<<<<<<<
 *         # Header
 ...
 */
  ...
  /* "/home/james/projects/bx-python/code/bx-python/lib/bx/bbi/cirtree_file.pyx":43
 *         self.end_base = reader.read_uint32()
 *         self.file_size = reader.read_uint64()
 *         self.items_per_slot = reader.read_uint32()             # <<<<<<<<<<<<<<
 *         # Skip reserved
 ...
 */
  ...
  /* "/home/james/projects/bx-python/code/bx-python/lib/bx/bbi/cirtree_file.pyx":45
 *         self.items_per_slot = reader.read_uint32()
 *         # Skip reserved
 *         reader.read_uint32()             # <<<<<<<<<<<<<<
 *         # Save root
 ...
 */
  ...
  /* "/home/james/projects/bx-python/code/bx-python/lib/bx/bbi/cirtree_file.pyx":47
 *         reader.read_uint32()
 *         # Save root
 *         self.root_offset = reader.tell()             # <<<<<<<<<<<<<<
 * 
...
/* "/home/james/projects/bx-python/code/bx-python/lib/bx/bbi/cirtree_file.pyx":49
 *         self.root_offset = reader.tell()
 * 
 *     def r_find_overlapping( self, int level, bits64 index_file_offset, bits32 chrom_ix, bits32 start, bits32 end, object rval, object reader ):             # <<<<<<<<<<<<<<
 *         cdef UBYTE is_leaf
...
static PyObject *__pyx_pf_2bx_3bbi_12cirtree_file_11CIRTreeFile_r_find_overlapping(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    __pyx_v_level = __Pyx_PyInt_AsInt(PyTuple_GET_ITEM(__pyx_args, 0)); if (unlikely((__pyx_v_level == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 49; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_index_file_offset = __Pyx_PyInt_AsUnsignedLongLong(PyTuple_GET_ITEM(__pyx_args, 1)); if (unlikely((__pyx_v_index_file_offset == (unsigned PY_LONG_LONG)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 49; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_chrom_ix = __Pyx_PyInt_AsUnsignedInt(PyTuple_GET_ITEM(__pyx_args, 2)); if (unlikely((__pyx_v_chrom_ix == (unsigned int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 49; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_start = __Pyx_PyInt_AsUnsignedInt(PyTuple_GET_ITEM(__pyx_args, 3)); if (unlikely((__pyx_v_start == (unsigned int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 49; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_end = __Pyx_PyInt_AsUnsignedInt(PyTuple_GET_ITEM(__pyx_args, 4)); if (unlikely((__pyx_v_end == (unsigned int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 49; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_rval = PyTuple_GET_ITEM(__pyx_args, 5);
    __pyx_v_reader = PyTuple_GET_ITEM(__pyx_args, 6);
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
 ...
 */
  ...
  /* "/home/james/projects/bx-python/code/bx-python/lib/bx/bbi/cirtree_file.pyx":57
 *         assert is_leaf == 0 or is_leaf == 1
 *         reader.read_uint8()
 *         child_count = reader.read_uint16()             # <<<<<<<<<<<<<<
 *         # Read block
 ...
 */
  if (__pyx_v_is_leaf) {
    ...
    /* "/home/james/projects/bx-python/code/bx-python/lib/bx/bbi/cirtree_file.pyx":60
 *         # Read block
 *         if is_leaf:
 *             self.r_find_overlapping_leaf( level, chrom_ix, start, end, rval, child_count, reader )             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    __pyx_t_8 = 0;
    __pyx_t_9 = 0;
    __pyx_t_9 = PyObject_Call(__pyx_t_3, __pyx_t_10, NULL); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 60; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_9);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  ...
  /*else*/ {
    ...
    /* "/home/james/projects/bx-python/code/bx-python/lib/bx/bbi/cirtree_file.pyx":62
 *             self.r_find_overlapping_leaf( level, chrom_ix, start, end, rval, child_count, reader )
 *         else:
 *             self.r_find_overlapping_parent( level, chrom_ix, start, end, rval, child_count, reader )             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_7 = 0;
    __pyx_t_1 = 0;
    __pyx_t_1 = PyObject_Call(__pyx_t_9, __pyx_t_2, NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 62; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
...
/* "/home/james/projects/bx-python/code/bx-python/lib/bx/bbi/cirtree_file.pyx":64
 *             self.r_find_overlapping_parent( level, chrom_ix, start, end, rval, child_count, reader )
 * 
 *     def r_find_overlapping_leaf( self, int level, bits32 chrom_ix, bits32 start, bits32 end, object rval,             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pf_2bx_3bbi_12cirtree_file_11CIRTreeFile_r_find_overlapping_leaf(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    __pyx_v_level = __Pyx_PyInt_AsInt(PyTuple_GET_ITEM(__pyx_args, 0)); if (unlikely((__pyx_v_level == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 64; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_chrom_ix = __Pyx_PyInt_AsUnsignedInt(PyTuple_GET_ITEM(__pyx_args, 1)); if (unlikely((__pyx_v_chrom_ix == (unsigned int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 64; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_start = __Pyx_PyInt_AsUnsignedInt(PyTuple_GET_ITEM(__pyx_args, 2)); if (unlikely((__pyx_v_start == (unsigned int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 64; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_end = __Pyx_PyInt_AsUnsignedInt(PyTuple_GET_ITEM(__pyx_args, 3)); if (unlikely((__pyx_v_end == (unsigned int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 64; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_rval = PyTuple_GET_ITEM(__pyx_args, 4);
    __pyx_v_child_count = __Pyx_PyInt_AsUnsignedShort(PyTuple_GET_ITEM(__pyx_args, 5)); if (unlikely((__pyx_v_child_count == (unsigned short)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 65; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_reader = PyTuple_GET_ITEM(__pyx_args, 6);
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
 ...
 */
    ...
    if (__pyx_t_12) {
      ...
      /* "/home/james/projects/bx-python/code/bx-python/lib/bx/bbi/cirtree_file.pyx":77
 *             size = reader.read_uint64()
 *             if overlaps( chrom_ix, start, end, start_chrom_ix, start_base, end_chrom_ix, end_base ):
 *                 rval.append( ( offset, size ) )             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_t_11 = 0;
      __pyx_t_10 = 0;
      __pyx_t_10 = __Pyx_PyObject_Append(__pyx_v_rval, __pyx_t_9); if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 77; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_10);
      __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
      __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
      goto __pyx_L8;
...
/* "/home/james/projects/bx-python/code/bx-python/lib/bx/bbi/cirtree_file.pyx":79
 *                 rval.append( ( offset, size ) )
 * 
 *     def r_find_overlapping_parent( self, int level, bits32 chrom_ix, bits32 start, bits32 end, object rval,             # <<<<<<<<<<<<<<
 *                                   bits16 child_count, object reader ):
...
static PyObject *__pyx_pf_2bx_3bbi_12cirtree_file_11CIRTreeFile_r_find_overlapping_parent(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    __pyx_v_level = __Pyx_PyInt_AsInt(PyTuple_GET_ITEM(__pyx_args, 0)); if (unlikely((__pyx_v_level == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_chrom_ix = __Pyx_PyInt_AsUnsignedInt(PyTuple_GET_ITEM(__pyx_args, 1)); if (unlikely((__pyx_v_chrom_ix == (unsigned int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_start = __Pyx_PyInt_AsUnsignedInt(PyTuple_GET_ITEM(__pyx_args, 2)); if (unlikely((__pyx_v_start == (unsigned int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_end = __Pyx_PyInt_AsUnsignedInt(PyTuple_GET_ITEM(__pyx_args, 3)); if (unlikely((__pyx_v_end == (unsigned int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_rval = PyTuple_GET_ITEM(__pyx_args, 4);
    __pyx_v_child_count = __Pyx_PyInt_AsUnsignedShort(PyTuple_GET_ITEM(__pyx_args, 5)); if (unlikely((__pyx_v_child_count == (unsigned short)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 80; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_reader = PyTuple_GET_ITEM(__pyx_args, 6);
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
 ...
 */
  ...
  /* "/home/james/projects/bx-python/code/bx-python/lib/bx/bbi/cirtree_file.pyx":86
 *         start_chrom_ix = []; start_base = []; end_chrom_ix = []; end_base = []
 *         offset = []
 *         for i from 0 <= i < child_count:             # <<<<<<<<<<<<<<
 *             ## start_chrom_ix[i] = reader.read_bits32()
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_4 = PyList_Append(((PyObject *)__pyx_v_start_chrom_ix), __pyx_t_3); if (unlikely(__pyx_t_4 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 92; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_4 = PyList_Append(((PyObject *)__pyx_v_start_base), __pyx_t_1); if (unlikely(__pyx_t_4 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 93; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_4 = PyList_Append(((PyObject *)__pyx_v_end_chrom_ix), __pyx_t_3); if (unlikely(__pyx_t_4 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_4 = PyList_Append(((PyObject *)__pyx_v_end_base), __pyx_t_1); if (unlikely(__pyx_t_4 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 95; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

    /* "/home/james/projects/bx-python/code/bx-python/lib/bx/bbi/cirtree_file.pyx":96
 *             end_chrom_ix.append( reader.read_uint32() )
 *             end_base.append( reader.read_uint32() )
 *             offset.append( reader.read_uint64() )             # <<<<<<<<<<<<<<
 *         # Now recurse
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_4 = PyList_Append(((PyObject *)__pyx_v_offset), __pyx_t_3); if (unlikely(__pyx_t_4 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 96; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  }
 ...
 */
    ...
    if (__pyx_t_11) {
      ...
      /* "/home/james/projects/bx-python/code/bx-python/lib/bx/bbi/cirtree_file.pyx":100
 *         for i from 0 <= i < child_count:
 *             if overlaps( chrom_ix, start, end, start_chrom_ix[i], start_base[i], end_chrom_ix[i], end_base[i] ):
 *                 self.r_find_overlapping( level + 1, offset[i], chrom_ix, start, end, rval, reader )             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_t_6 = 0;
      __pyx_t_5 = 0;
      __pyx_t_5 = PyObject_Call(__pyx_t_10, __pyx_t_1, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 100; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
...
static PyObject *__pyx_pf_2bx_3bbi_12cirtree_file_11CIRTreeFile_find_overlapping_blocks(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    __pyx_v_chrom_ix = __Pyx_PyInt_AsUnsignedInt(PyTuple_GET_ITEM(__pyx_args, 0)); if (unlikely((__pyx_v_chrom_ix == (unsigned int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_start = __Pyx_PyInt_AsUnsignedInt(PyTuple_GET_ITEM(__pyx_args, 1)); if (unlikely((__pyx_v_start == (unsigned int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_end = __Pyx_PyInt_AsUnsignedInt(PyTuple_GET_ITEM(__pyx_args, 2)); if (unlikely((__pyx_v_end == (unsigned int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
 ...
 */
  ...
  __pyx_t_4 = 0;
  __pyx_t_5 = 0;
  __pyx_t_5 = PyObject_Call(__pyx_t_1, __pyx_t_6, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 104; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;

  /* "/home/james/projects/bx-python/code/bx-python/lib/bx/bbi/cirtree_file.pyx":105
 *         rval = []
 *         self.r_find_overlapping( 0, self.root_offset, chrom_ix, start, end, rval, self.reader )
 *         return rval             # <<<<<<<<<<<<<<
 */
