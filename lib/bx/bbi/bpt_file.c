 ...
 *             for i from 0 <= i < child_count:
 */
    __pyx_t_3 = PyObject_GetAttr(__pyx_v_self->reader, __pyx_n_s__read_bits64); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 55; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
 ...
 * 
 */
      __pyx_t_3 = PyObject_GetAttr(__pyx_v_self->reader, __pyx_n_s__read_bits64); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
