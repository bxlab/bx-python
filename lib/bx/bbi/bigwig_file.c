/* Generated by Cython 0.15.1 on Sun Oct 30 12:20:38 2011 */
...
static char __pyx_k_16[] = "bx.misc.binary_file";
 ...
 * cdef class IntervalAccumulatingBlockHandler( BigWigBlockHandler ):
 */
  __pyx_t_1 = PyObject_GetAttr(((PyObject *)__pyx_v_self->sd), __pyx_n_s_2); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 91; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
...
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_bigwig_file(void)");
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("bigwig_file"), __pyx_methods, __Pyx_DOCSTR(__pyx_k_15), 0, PYTHON_API_VERSION);
  #else
