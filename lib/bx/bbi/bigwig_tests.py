...
class TestBigWig(unittest.TestCase):
    ...
    def test_get_summary(self):
        ...
        self.assertEqual( map(float, means), [-0.17557571594973645, -0.054009292602539061, -0.056892242431640622, -0.03650328826904297, 0.036112907409667966, 0.0064466032981872557, 0.036949024200439454, 0.076638259887695306, 0.043518108367919923, 0.01554749584197998] )
    ...
    def test_get_leaf(self):
        ...
        means = [ x['mean'] for x in data ]
        self.assertEqual( map(float, means), [0.050842501223087311, -2.4589500427246094, 0.050842501223087311, 0.050842501223087311, 0.050842501223087311] )
